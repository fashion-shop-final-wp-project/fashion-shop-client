...
function Header()
{
        ...
        return (
            <section className="">
                <div className={"flex items-center gap-[10px]"}>
                    <img className={"h-[15px]"} src="https://cms.nkm-atelier.de/img/nkm-ratings-trusted-shops-bewertungen.png" alt=""/>
    ...
    return (
        <header className="border border-b border-b-csc-B py-[10px]">
